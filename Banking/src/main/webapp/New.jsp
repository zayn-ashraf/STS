...
<center>
	...
	<H2>OPEN ACCOUNT FORM</H2>
		...
		<tr>
			...
			<tr>
				<td><b>Address:</td>
				<td><input type="address" name="add"></b></td>
			</tr>

			<tr>
				<td><b>Mobile No:</td>
				<td><input type="text" name="mno"></b></td>
			</tr>
			<tr>
			...
			<p>QNB provides a comprehensive suite of products and services,
				...
				22 6229 6300 with any comments and suggestions you might have.</p>			</div>
</body>
</html>